                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select name="discount_is_active" id="discount_is_active" class="form-control">
                                    <option value="1" {{ old('discount_is_active', 1) == '1' ? 'selected' : '' }}>
                                        {{ translate('active') }}
                                    </option>
                                    <option value="0" {{ old('discount_is_active') == '0' ? 'selected' : '' }}>
                                        {{ translate('inactive') }}
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea name="discount_note" id="discount_note" 
                                          class="form-control" 
                                          rows="2"
                                          placeholder="{{ translate('internal_discount_note_placeholder') }}">{{ old('discount_note') }}</textarea>
                            </div>
                        </div>
                    </div>

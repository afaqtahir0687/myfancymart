...
class ProductService
{
    ...
    public function getAddProductData(object $request, string $addedBy): array
    {
        ...
        return [
            ...
            'discount_start_date' => $request->get('discount_start_date'),
            'discount_end_date' => $request->get('discount_end_date'),
            'discount_is_active' => $request->get('discount_is_active', 1),
            'discount_note' => $request->get('discount_note'),
